  ...
  return (
    <div className="flex items-start justify-center min-h-full p-8">
      <div className="max-w-md mx-auto mt-20 bg-white rounded-xl border border-gray-200 shadow-sm p-10 text-center">
        ...
        <a
          href="/dashboard/new"
          className="mt-7 inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-indigo-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        >
          <svg
            className="h-4 w-4"
            fill="none"
